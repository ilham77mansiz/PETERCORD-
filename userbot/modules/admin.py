...
async def rm_deletedacc(show):
    ...
    # Well
    if not admin and not creator:
        return await show.edit("`Petercord Bukan Admin Disini!`")

    await show.edit("`Menghapus Akun Terhapus...\nMohon Menunggu Petercord Sedang Dalam Proses`")
    del_u = 0
    del_a = 0
    ...
    async for user in show.client.iter_participants(show.chat_id):
        if user.deleted:
            try:
                ...
                return await show.edit("`Petercord Tidak Memiliki Izin Banned Dalam Grup Ini`")
...
async def get_users(show):
    ...
    try:
        ...
        await show.edit("Petercord, Grup Ini Terlalu Besar Mengunggah Daftar Pengguna Sebagai File.")
...
async def get_usersdel(show):
    ...
    try:
        ...
        await show.edit(
            "Petercord, Grup Ini Terlalu Besar, Mengunggah Daftar Akun Terhapus Sebagai File."
        )
        file = open("daftarpengguna.txt", "w+")
        file.write(mentions)
        file.close()
...
async def get_bots(show):
    ...
    try:
        ...
        await show.edit("Petercord, Terlalu Banyak Bot Di Grup Ini, Mengunggah Daftar Bot Sebagai File.")
